...
class GezilecekYerlerSayfasi extends StatelessWidget {
  ...
  final List<GezilecekYer> yerler = const [
    GezilecekYer(
      ...
      resimUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/cb/Kotor_Bay_from_Vrmac_2017.jpg/800px-Kotor_Bay_from_Vrmac_2017.jpg',
    ...
    GezilecekYer(
      ...
      resimUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/Ostrog_monastery_Montenegro.jpg/800px-Ostrog_monastery_Montenegro.jpg',
    ...
    GezilecekYer(
      ...
      resimUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Budva_Old_Town_panorama.jpg/800px-Budva_Old_Town_panorama.jpg',
    ...
    GezilecekYer(
      ...
      resimUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Durmitor_National_Park_Montenegro.jpg/800px-Durmitor_National_Park_Montenegro.jpg',
    ...
    GezilecekYer(
      ...
      resimUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Sveti_Stefan_Montenegro_2011.jpg/800px-Sveti_Stefan_Montenegro_2011.jpg',
    ...
    GezilecekYer(
      ...
      resimUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Rijeka_Crnojevi%C4%87a_view.jpg/800px-Rijeka_Crnojevi%C4%87a_view.jpg',
    ...
    GezilecekYer(
      ...
      resimUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Skadar_Lake_Montenegro.jpg/800px-Skadar_Lake_Montenegro.jpg',
    ...
    GezilecekYer(
      ...
      resimUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Niagara_falls_Podgorica.jpg/800px-Niagara_falls_Podgorica.jpg',
    ...
    GezilecekYer(
      ...
      resimUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Dajbabe_monastery.jpg/800px-Dajbabe_monastery.jpg',
    ...
    GezilecekYer(
      ...
      resimUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/47/Stari_Bar_walls.jpg/800px-Stari_Bar_walls.jpg',
    ...
    GezilecekYer(
      ...
      resimUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/Ulcinj_Old_Town_2012.jpg/800px-Ulcinj_Old_Town_2012.jpg',
    ...
    GezilecekYer(
      ...
      resimUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/Cetinje_Museum.jpg/800px-Cetinje_Museum.jpg',
    ...
    GezilecekYer(
      ...
      resimUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Perast_Montenegro_Gospa_od_Skrpjela.jpg/800px-Perast_Montenegro_Gospa_od_Skrpjela.jpg',
    ...
    GezilecekYer(
      ...
      resimUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/Kolasin_ski_resort.jpg/800px-Kolasin_ski_resort.jpg',
    ...
    GezilecekYer(
      ...
      resimUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Biogradsko_jezero_2011.jpg/800px-Biogradsko_jezero_2011.jpg',
